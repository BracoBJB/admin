                    ...
                    <div class="card-body card-block">
                        <form action="" method="post" action="<?= base_url() ?>master/login">
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="vat" class=" form-control-label">Seleccione un docente</label>
                            ...
                            <div class="form-group">
                                <label for="vat" class=" form-control-label">Seleccione una materia</label>
                                <select class="standardSelect form-control" id="docente" name="docente" data-placeholder="Elija autor(es)...">
                                <?php if ( isset($docentes))
                                {
                                    foreach($docentes  -> result() as $doc)
                            ...
                            <div class="form-group">
                                <label for="vat" class=" form-control-label">Seleccione grupo(s)</label>
                                <select class="standardSelect form-control" multiple id="grupos" name="grupos[]" data-placeholder="Elija un grupo(s)...">
                            ...
                            <div class="form-group">
                                <label for="descripcion" class="form-control-label">Descripción del material</label>
                                <textarea name="descripcion" id="descripcion" rows="3" cols="80" class="form-control"><?=isset($post)?$post->descripcion:set_value('descripcion');?></textarea>
